...
class screens:
    ...
    # this initializes some fonts used throughout the gameplay
    def __init__(self,size):
        self.font1=pygame.font.SysFont('candara',int(size[0]/13),bold=False,italic=False)
        self.font2=pygame.font.SysFont('franklingothicmedium',int(size[0]/13),bold=False,italic=False)
        self.font3=pygame.font.SysFont('candara',int(size[0]/21.67),bold=False,italic=False)
        self.font4=pygame.font.SysFont('candara',int(size[0]/18.57),bold=False,italic=False)
        self.font5=pygame.font.SysFont('candara',int(size[0]/23.21),bold=False,italic=False)
    ...
    def menu(self,screen,size):
        ...
        self.draw_text(screen,"Tic-Tac-Toe!",self.font1,(0,0,0),size[0]/2,size[1]/6+size[0]/130)
        self.draw_text(screen,"OTHELLO!",self.font1,(0,0,0),size[0]/2,size[1]/2+size[0]/130)
        self.draw_text(screen,"Connect FOUR!",self.font1,(0,0,0),size[0]/2,5*size[1]/6+size[0]/130)
        self.draw_text(screen,"Welcome! To pick a game, click anywhere in its box!",self.font5,(255,255,255),size[0]/2,size[1]+size[0]*3/65)
    ...
    def sort_by_what(self,screen,size):
        ...
        self.draw_text(screen,"NUMBER OF WINS",self.font4,(0,0,0),size[0]/2,size[1]/10+size[0]/130)
        self.draw_text(screen,"NUMBER OF LOSSES",self.font4,(0,0,0),size[0]/2,3*size[1]/10+size[0]/130)
        self.draw_text(screen,"NUMBER OF DRAWS",self.font4,(0,0,0),size[0]/2,5*size[1]/10+size[0]/130)
        self.draw_text(screen,"WIN TO LOSS RATIO",self.font4,(0,0,0),size[0]/2,7*size[1]/10+size[0]/130)
        self.draw_text(screen,"TOTAL GAMES PLAYED",self.font4,(0,0,0),size[0]/2,9*size[1]/10+size[0]/130)
        self.draw_text(screen,"Click to sort by that statistic! (check your terminal)",self.font5,(255,255,255),size[0]/2,size[1]+3*size[0]/65)
    ...
    def prompt_to_quit(self,screen,size):
        ...
        self.draw_text(screen,"To pick a choice, click anywhere in its box!",self.font3,(255,255,255),size[0]/2,size[1]+3*size[0]/65)
    ...
    def footer(self,screen,size):
        ...
        self.draw_text(screen,"Click anywhere to Continue",self.font3,(255,255,255),size[0]/2,size[1]+3*size[0]/65)